    ...
    <div class="col grid_12_of_12 last">		
        <div class="content clearfix">
                                ...
                                <div class="product-price">
                                    ...
                                    if (edd_has_variable_prices(get_the_ID())) {
                                        // if the download has variable prices, show the first one as a starting price
                                         printf(esc_html_e('Starting at: %s','smartshop'), edd_price(get_the_ID()));
                                    } else {
            ...
            <?php if (!edd_has_variable_prices(get_the_ID())) { ?>
                                <?php echo edd_get_purchase_link(get_the_ID(), esc_html_e('Add to Cart','smartshop'), 'button'); ?>
                            <?php } ?>
                                <a href="<?php the_permalink(); ?>"><?php esc_html_e('View Details','smartshop'); ?></a>

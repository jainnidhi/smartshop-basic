...
<div id="page-header-container" class="container">
     <div class="headsection row">
        <h2 class="title archive-title"><?php printf(esc_html_e('Category Archives: %s', 'smartshop'), '<span class="cat-archive">' . single_cat_title('', false) . '</span>'); ?></h2>
            ...
            <?php if (have_posts()) : ?>
                ...
                <?php while (have_posts()) : the_post(); ?>
                    ...
                    <div <?php post_class('clearfix'); ?>  id="post-<?php the_ID(); ?>">
                        ...
                        <span class="post-meta"><small><?php the_time(__esc_html_e('F j, Y','smartshop')); ?> <!-- by <?php the_author() ?> --></small></span>
                        <?php the_excerpt(); ?>
